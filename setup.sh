...
export 'ADDRESS_WITH_BALANCES_UPDATE_INTERVAL=1 * 3'
echo 'ADDRESS_WITH_BALANCES_UPDATE_INTERVAL=1 * 3'

export 'TXS_COUNT_CACHE_PERIOD=2 * 2 * 1'
echo 'TXS_COUNT_CACHE_PERIOD=2 * 2 * 1'
